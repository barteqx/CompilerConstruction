...
// Here come the tables:
   ...
   unsigned int starts [] = 
   {
      0, 10, 12, 21, 24, 27, 29, 33, 37, 39, 48, 
      51, 54, 0 };
   ...
   int parsetable [] = 
   {
      ...
      tkn_T, 10002, 
      tkn_U, 10003, 
      tkn_identifier, 10004, 
      tkn_lpar, 10005, 
      tkn_plus, 10006, 
      tkn_Eof, -10001, 0, 
      tkn_plus, -10001, 10007, 
      tkn_rpar, -10001, 0, 
