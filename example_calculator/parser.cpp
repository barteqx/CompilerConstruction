...
// Here come the tables:
   ...
   unsigned int starts [] = 
   {
      ...
      75, 80, 83, 86, 88, 111, 116, 119, 122, 126, 
      129, 133, 135, 137, 139, 142, 144, 151, 155, 158, 
      165, 172, 175, 178, 181, 183, 186, 193, 0 };

   unsigned int defaults [] = {
      0, 1, 2, 3, 4, 1, 5, 5, 8, 9, 10, 
      11, 12, 13, 7, 15, 16, 17, 18, 8, 20, 
...
case 19:
   ...
   break;
case 20:
   reduction_20( parsestack, parsestack. end( ) - 0 );
   break;
case 21:
