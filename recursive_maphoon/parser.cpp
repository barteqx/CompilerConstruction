...
{ reduce( stack, position, tkn_LISTARGS, l ); return; }
...
{ reduce( stack, position, tkn_LISTARGS, LIST1 ); return; }
{ reduce( stack, position, tkn_LISTARGS, tkn_LISTARGS ); return; }
...
case 0:
   ...
   break;
case 1:
   reduction_1( parsestack, parsestack. end( ) - 4, parsestack. end( ) - 4, parsestack. end( ) - 3, parsestack. end( ) - 2, parsestack. end( ) - 1 );
   break;
case 2:
